<template>
  <v-container fill-height fluid text-center >
      <v-container>
          <v-row>
              <v-col class="orange--text text-center mx-auto pb-4" cols="1" sm="4" offset="4"><h1 class="h1">Login</h1></v-col>
          </v-row>
          <v-row class="elavation-3 mx-auto">
              <v-col cols="auto">
                  <v-img max-height="350" max-widht="250" src="@/assets/images/Logo.png"></v-img>
              </v-col>
              <v-col>
                  <v-form>
                      ...
                      <v-btn class="ml-3" color="red" @click="reset">Cancelar</v-btn>
                  </v-form>
              </v-col>
          </v-row>
      </v-container>
      ...
      <v-dialog v-model="novaConta" persistent max-widht="300">
          <v-card>
              <v-card-title>A conta nao foi encontrada</v-card-title>
              <v-card-text>
                  A conta nao foi localizada. Deseja criar uma nova conta com os dados informados?
              </v-card-text>
              <v-card-actions>
                  <v-spacer></v-spacer>
