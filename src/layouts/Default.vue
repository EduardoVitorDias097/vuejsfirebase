<template>
  <v-app>
    <v-app-bar app color="orange" dark elavation="1">
    ...
    <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
      <v-list dense color="orange" dark>
        <v-list-item>
          <v-list-item-action>
      ...
      <v-list-item class="px=2" @click="mini = !mini">
        ...
        <v-list-item-content> Eduardo Vitor </v-list-item-content>
    ...
    <v-footer app class="py-3" color="orange "> <span class="caption">MyTodoList &copy;2021</span> </v-footer>
  </v-app>
</template>
